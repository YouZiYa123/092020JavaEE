...
<head>
	...
	<title> [<%=session.getAttribute("username")%>] Marketplace - Books & Stationery </title>
	<style>
		*{
			margin:0;
			padding: 0;
...
<h1 style="text-align:center; padding-bottom: 2%; padding-top:2%; margin-top: 0px; font-size: 60px; font-weight:650; color: #007bb6; padding-left: 33px;" >Books & Stationery</h1>
...
<%
	...
	ResultSet rs = stm.executeQuery("SELECT * FROM user.product\n" +
			"where product_category = 'Books & Stationery'\n");
...
<div class="Row">
	...
	<div class="product">
		<div class="pro-con">
			...
			<h2 style="font-size: 18px; font-weight:bold; color: #007bb6; text-align: center;"><%=rs.getString("product_name")%></h2>
