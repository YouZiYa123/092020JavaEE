...
<head>
	...
	<title> [<%=session.getAttribute("username")%>] Marketplace - All Product </title>
	<style>
		*{
			margin:0;
			padding: 0;
...
<div style= "background-color: #EDEBEB;">
	<h1 style="text-align:center; padding-bottom: 2%; padding-top:2%; margin-top: 0px; font-size: 60px; font-weight:650; color: #14C9B2; padding-left: 33px;" >All Product</h1>
	...
	<div class="Row">
		...
		<div class="product">
			<div class="pro-con">
				...
				<h2 style="font-size: 18px; font-weight:bold; color: #14C9B2; text-align: center;"><%=rs.getString("product_name")%></h2>
