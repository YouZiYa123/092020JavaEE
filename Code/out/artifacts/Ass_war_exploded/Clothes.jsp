...
<head>
	...
	<title>[<%=session.getAttribute("username")%>] Marketplace - Clothes & Accessories </title>
	<style>
		*{
			margin:0;
			padding: 0;
...
<div class="navbar">
	<div class="logo">
		<img src="http://www.xmu.edu.my/_upload/tpl/08/9f/2207/template2207/htmlRes/xxde_022.png" style="background: #3BC1D0" width="150px" />
	</div>
	<nav>
		<ul>
...
<div style= "background-color: #EDEBEB;">
	<h1 style="text-align:center; padding-bottom: 2%; padding-top:2%; margin-top: 0px; font-size: 60px; font-weight:650; color: #D35B92; padding-left: 33px;" >Clothes & Accessories</h1>

	<%
		Class.forName("com.mysql.jdbc.Driver");
		Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/user", "root","123456");
		Statement stm = conn.createStatement();
		ResultSet rs = stm.executeQuery("SELECT * FROM user.product\n" +
				"where product_category = 'Clothes & Accessories'\n");
	...
	<div class="Row">
		...
		<div class="product">
			<div class="pro-con">
				<a href="Bdetail.jsp?pid=<%=rs.getString("product_id")%>" target="_blank">
					<img src="./ProductDisplayServlet?product_id=<%=rs.getString("product_id")%>"/>
				</a>
				<h2 style="font-size: 18px; font-weight:bold; color: #D35B92; text-align: center;"><%=rs.getString("product_name")%></h2>
				<p style="font-weight:bold; font-size: 20px;"><%=rs.getString("price")%></p>
			</div>
		</div>
		<%
		}
